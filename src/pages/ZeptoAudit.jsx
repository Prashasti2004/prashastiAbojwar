            ...
            <div className="container">
                ...
                <FadeIn delay={0.1}>
                    <section className="executive-snapshot">
                        <h2 className="section-label">Executive Snapshot (Click to explore)</h2>
                        <div className="kpi-grid">
                            {kpiData.map((kpi) => (
                                <div
                                    key={kpi.id}
                                    className="kpi-card interactive"
                                    onClick={() => scrollToSection(kpi.id)}
                                >
                ...
                <div className="audit-group">
                    <FadeIn>
                        <h2 className="group-title">I. Operational Efficiency Levers</h2>
                    </FadeIn>

                    {/* Section 1: Last-Mile Fleet */}
                    <FadeIn delay={0.2}>
                        <section className="audit-section" id="audit-fleet">
                            <h2 className="section-number">1.1 Last-Mile Fleet Utilization</h2>
                                    ...
                                    <div className="chart-container">
                                        ...
                                        <div className="bar-chart">
                                            <div className="bar-group">
                                                <div className="bar before" style={{ height: '67%' }}>
                                                    <span className="bar-label">1.2</span>
                                                </div>
                                                <span className="bar-caption">Before</span>
                                            </div>
                                            <div className="bar-group">
                                                <div className="bar after" style={{ height: '100%' }}>
                    ...
                    <FadeIn delay={0.3}>
                        <section className="audit-section alt" id="audit-inventory">
                            <h2 className="section-number">1.2 Fresh Produce Shrinkage</h2>
                            ...
                            <div className="section-grid reverse">
                                <div className="section-visual">
                                    <div className="chart-container">
                                        ...
                                        <div className="bar-chart">
                                            <div className="bar-group">
                                                <div className="bar before" style={{ height: '100%' }}>
                                                    <span className="bar-label">15%</span>
                                                </div>
                                                <span className="bar-caption">Before</span>
                                            </div>
                                            <div className="bar-group">
                                                <div className="bar after" style={{ height: '27%' }}>
                    ...
                    <FadeIn delay={0.4}>
                        <section className="audit-section" id="audit-refunds">
                            <h2 className="section-number">1.3 Refund Leakage</h2>
                                ...
                                <div className="section-visual">
                                    <div className="chart-container">
                                        ...
                                        <div className="bar-chart">
                                            ...
                                            <div className="bar-group">
                                                <div className="bar after" style={{ height: '44%' }}>
                ...
                <div className="audit-group">
                    <FadeIn>
                        <h2 className="group-title">II. Strategic Execution Framework</h2>
                    </FadeIn>

                    {/* Section 4: Org Structure Evolution */}
                    <FadeIn delay={0.6}>
                        <section className="audit-section org-section">
                            <h2 className="section-number">2.1 Org Structure Evolution</h2>
                    ...
                    <FadeIn delay={0.7}>
                        <section className="audit-section alt decision-section">
                            <h2 className="section-number">2.2 Decision Ownership Boundaries</h2>
                    ...
                    <FadeIn delay={0.8}>
                        <section className="audit-section kpi-system-section">
                            <h2 className="section-number">2.3 KPI System</h2>
